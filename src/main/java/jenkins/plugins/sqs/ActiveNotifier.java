...
public class ActiveNotifier implements FineGrainedNotifier {
	...
	public ActiveNotifier(SQSNotifier notifier, BuildListener listener) {
		super();
		this.notifier = notifier;
		this.listener = listener;
	}

	private SQSService getSQS(AbstractBuild r) {
		return notifier.newSQSService(r, listener);
	}
	...
	private void notifyStart(AbstractBuild build, String message) {
		...
		if (previousBuild == null) {
			getSQS(build).publish(message, "good");
		} else {
			getSQS(build).publish(message, getBuildColor(previousBuild));
		}
	}
	...
	public static class MessageBuilder {
		...
		private SQSNotifier notifier;
		private AbstractBuild build;

		public MessageBuilder(SQSNotifier notifier, AbstractBuild build) {
			this.notifier = notifier;
